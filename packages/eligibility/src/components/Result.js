...
function Result(props) {
  return (
    ...
    {props.quizScore < 9 && props.questions.length > 0 && (
      ...
      <div className="pt-3 pl-4 pr-4 pb-4">
        You correctly answered <strong>{props.quizScore}/9</strong> in the Eligibility Test. The digital solution you are considering to nominate is not currently eligible to become a DPG since you must correctly answer <strong>9/9</strong> in order to be eligible. 
